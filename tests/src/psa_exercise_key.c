                                        ...
                                        const mbedtls_pk_context *pk)
{
    ...
    switch (pk_type) {
...
#if defined(MBEDTLS_PK_USE_PSA_EC_DATA) || defined(PSA_CRYPTO_API_VERSION_MAJOR)
        ...
        case MBEDTLS_PK_ECDSA:
            ...
            break;
#endif /* MBEDTLS_PK_USE_PSA_EC_DATA || PSA_CRYPTO_API_VERSION_MAJOR */
    ...
    defined(MBEDTLS_VERSION_MAJOR) && (MBEDTLS_VERSION_MAJOR < 4)
        ...
        * MBEDTLS_VERSION_MAJOR && (MBEDTLS_VERSION_MAJOR < 4) */
