...
psa_key_agreement_iop_t psa_key_agreement_iop_short(void);
#endif
#if defined(PSA_GENERATE_KEY_IOP_INIT)
psa_generate_key_iop_t psa_generate_key_iop_short(void);
#endif
#if defined(PSA_EXPORT_PUBLIC_KEY_INIT)
psa_export_public_key_iop_t psa_export_public_key_iop_short(void);
#endif
